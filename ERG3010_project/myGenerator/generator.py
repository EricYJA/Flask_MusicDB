...
class DataGenerator():
    ...
    def __init__(self, dataString, args):
...
def run_generate(data, input_string):
    args = HParam()
...
if __name__ == '__main__':
    ...
    data = DataGenerator('lijian.txt', args)
    model = Model(args, data)

    prime = u'坠落和上升含混难辨'
    generate(prime, data, model, args)
    # summary_writer = tf.train.SummaryWriter("D:\\Academic_work\\01_ERG3010\\Project\\lyricsAnalysis1\\lyricsgenertor\\logs", sess.graph_def)
# 可视化
