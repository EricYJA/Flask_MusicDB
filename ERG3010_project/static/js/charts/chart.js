...
$.getJSON('../static/sentiment_data_1.json', function (_data){
	getChart6(_data);
});
...
function getChart6(data){
	var myChart = echarts.init(document.getElementById('0a3d07e7877a49c4b9d391d816f674f6'), 'light', {renderer: 'canvas'});
	var option = {
		"title": [
			{
				"text": "Probability of Positive Property",
				"left": "center",
				"top": "auto",
				"textStyle": {
					"fontSize": 20,
		...
		"series": [
			{
				"type": "liquidFill",
				"name": "Probability of Positive Property",
				"data": [
					data[0][1],
					0.5,
					0.4,
